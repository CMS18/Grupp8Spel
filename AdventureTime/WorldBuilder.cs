...
namespace AdventureTime
{
    public class WorldBuilder
    {
        ...
        public void BuildWorld()
        {
            ...
            Item högerStrumpa = new Item() { Name = "HÖGERSTRUMPA", Description = "Det är en blå skjorta, ett par jeans och \nEN blå högerstrumpa.", CanPickUp = true };
            ...
            // Items vv
            Room containerFrys = new Room() { Name = "FRYS", Description = "Inuti frysen är det så när på helt tomt förutom en djupfryst blå strumpa" };
            ...
            Exit hallToVardagsRum = new Exit() { newRoom = roomVardagsrum, Direction = "VÄSTER", isOpen = true, isContainer = false };
            ...
            containerFrys.RoomInventory.Add(vänsterstrumpa);
            ...
            roomKök.Exits.Add(kökToFrys);
            roomHall.Exits.Add(hallToKök);
            containerFrys.Exits.Add(frysToKök);
